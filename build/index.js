...
wp.blocks.registerBlockType('taurus-mcq-plugin/multiple-choice-quiz', {
  ...
  'save': function (props) {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "The Sky Color is ", props.attributes.skyColor, " and the Grass Color is ", props.attributes.grassColor);
  }
});
}();
/******/ })()
